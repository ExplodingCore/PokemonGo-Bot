...
namespace PokemonGo.RocketAPI.Logic
{
    public class Logic
    {
        ...
        private async Task fncPokeStop(Client client, FortData[] pokeStops, bool metros30)
        {
            ...
            foreach (var pokeStop in pokeStops)
            {
                ...
                else
                {
                    ...
                    await RandomHelper.RandomDelay(50, 1000); // wait to start moving again 
                }
                #endregion
            }
        }
        ...
        private int GetRandomWalkspeed()
        {
            ...
            Logger.ColoredConsoleWrite(ConsoleColor.DarkRed, $"Random Speed: " + Math.Round((double)walkspeed) + " km/h");
            return walkspeed;
        }
